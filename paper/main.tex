...
El acceso a una justicia pronta y cumplida es un pilar fundamental de cualquier Estado de derecho. Sin embargo, lejos de ser una anomal\'{i}a exclusiva del sistema judicial colombiano, la congesti\'{o}n judicial es un fen\'{o}meno que hist\'{o}ricamente se ha replicado en m\'{u}ltiples pa\'{i}ses. India es considerado el pa\'{i}s con el peor retraso judicial del mundo, acumulando m\'{a}s de 45 millones de casos pendientes \cite{shamsan2026predictive}. Brasil supera los 80 millones de expedientes en tribunales \cite{deoliveira2022predicting}. Incluso potencias occidentales como Reino Unido sufren una crisis hist\'{o}rica de retrasos que genera que juicios por delitos graves tarden a\~{n}os en resolverse.

En el contexto local, el sistema judicial colombiano tramita m\'{a}s de 3 millones de casos nuevos cada a\~{n}o, frente a un d\'{e}ficit estructural de 6,420 servidores p\'{u}blicos. Seg\'{u}n estad\'{i}sticas a corte de 2024, el \'{\i}ndice de congesti\'{o}n alcanz\'{o} el 52.9\%, cifra que se mantuvo durante 2025 a pesar de estrategias como reformas legales y la digitalizaci\'{o}n de tr\'{a}mites. Entre las causas identificadas se encuentran el uso masivo de la acci\'{o}n de tutela y fallas estructurales en la gesti\'{o}n de procesos judiciales \cite{csj2023}, problem\'{a}ticas que afectan especialmente al nicho de derecho de familia en el Valle del Cauca. Algunos procesos civiles y de familia tardan hasta una d\'{e}cada en resolverse. Esta congesti\'{o}n no es uniforme: se concentra en regiones y tipos de despacho espec\'{i}ficos, y los factores que la impulsan siguen siendo poco comprendidos porque no existe una herramienta anal\'{i}tica sistem\'{a}tica que correlacione los atributos de los casos con su duraci\'{o}n.
...
El impacto de la congesti\'{o}n trasciende lo administrativo: en 2022, el programa \textit{Saludablemente} revel\'{o} que m\'{a}s del 60\% de los funcionarios judiciales presentaban alto riesgo psicosocial y un 83\% presentaba s\'{i}ntomas de estr\'{e}s con frecuencia da\~{n}ina para la salud, evidenciando que la sobrecarga compromete no solo la productividad sino la dignidad de quienes administran justicia \cite{csj2023}.
...
Shamsan Saleh et al.\ \cite{shamsan2026predictive} propusieron el modelo LJPE, un ensemble de dos niveles que combina m\'{u}ltiples clasificadores con ingenier\'{i}a de caracter\'{i}sticas espec\'{i}ficas del dominio legal (metadatos de casos, historial de votaciones y contenido sem\'{a}ntico de textos jur\'{i}dicos), alcanzando una precisi\'{o}n del 94.68\% en la predicci\'{o}n de resultados de la Corte Suprema de EE.UU. Este resultado sugiere que la ingenier\'{i}a de caracter\'{i}sticas es tan importante como la selecci\'{o}n del modelo en tareas de predicci\'{o}n judicial.

En el \'{a}rea de predicci\'{o}n de la duraci\'{o}n de procesos judiciales, de Oliveira et al.\ \cite{deoliveira2022predicting} aplicaron siete t\'{e}cnicas de aprendizaje autom\'{a}tico a casos de un Tribunal Regional del Trabajo en Brasil, encontrando que Adaboost funcionaba mejor con un R\textsuperscript{2} de 0.819 en la estimaci\'{o}n del tiempo de resoluci\'{o}n. Sin embargo, este estudio se limit\'{o} a una sola jurisdicci\'{o}n laboral y no consider\'{o} variables como la ubicaci\'{o}n geogr\'{a}fica o la vulnerabilidad social, que pueden afectar significativamente la duraci\'{o}n de los procesos.

En Am\'{e}rica Latina, \cite{gonzalez2022legal} aplicaron gradient boosting para predecir la duraci\'{o}n de casos laborales en Brasil, alcanzando MAPE de aproximadamente 18\%. \cite{perez2023judicial} utilizaron procesamiento de lenguaje natural en documentos judiciales colombianos para clasificar tipos de proceso. En Colombia, un equipo de la Universidad de La Sabana \cite{unisabana2026archivo} desarroll\'{o} una arquitectura de datos bajo el enfoque medall\'{o}n para integrar expedientes judiciales nacionales y entren\'{o} modelos para predecir si un caso se archivar\'{a}, seg\'{u}n variables como la etapa del proceso y el tipo de delito. Aunque este trabajo representa un avance en el an\'{a}lisis judicial en Colombia, se centra en clasificar casos archivados y no en predecir la duraci\'{o}n de los procesos ni detectar retrasos en \'{a}reas espec\'{i}ficas como el derecho de familia.

Hasta donde sabemos, ning\'{u}n trabajo previo ha combinado \'indices de vulnerabilidad municipal con predicci\'{o}n a nivel de caso para juzgados de familia colombianos.
